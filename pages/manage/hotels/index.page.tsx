...
const ManageHotels: FC<Props> = ({}) => {
  const { breadcrumbItems, tableColumns, tableData, pushToCreateHotel } =
    useManageHotel();
    ...
    <SupplierLayout breadcrumbItems={breadcrumbItems}>
      <div className={styles.container}>
        <div className={styles.container_top}>
          <Button type="primary" shape="round" onClick={pushToCreateHotel}>
            Thêm mới
          </Button>
          <Search
        ...
        <Button type="dashed" block onClick={pushToCreateHotel}>
          Thêm mới
        </Button>
      </div>
    </SupplierLayout>
